...
public class Day1_AsalSayi {
    public static void main(String[] args) {

        //10-100 arasındaki asal sayıları yazdıran programı yazınız.

        int kontrolBayrak=0;
        for (int sayi=10;sayi<100;sayi++) // 10'dan 100'e kadar sayıları dolaşacak.
        {
            for (int i=2;i<sayi;i++) // sayi degiskenine kadar i=2'den tüm sayilari dolasacak.
            {
